...
class ScheduleSelectItemModel {
  ...
  ScheduleSelectItemModel(this.id, this.isSelected, this.pairName);

  factory ScheduleSelectItemModel.from(String scheduleDocumentId,
      ScheduleEntity scheduleEntity, UserEntity userEntity) {
